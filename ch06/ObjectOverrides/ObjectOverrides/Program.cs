...
namespace ObjectOverrides
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Make some other reference to p1.
            Person p2 = p1;
            object o = p2;
            ...
            p1 = new ObjectOverrides.Person("Homer", "Simpson", 50);
            p2 = new ObjectOverrides.Person("Homer", "Simpson", 50);

            // Get stringfied version of objects.
