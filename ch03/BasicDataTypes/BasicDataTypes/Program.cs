...
namespace BasicDataTypes
{
    class Program
    {
        ...
        {
            Console.WriteLine("=> char type Funcitonality:");
            char myChar = 'a';
        ...
        {
            Console.WriteLine("=> Data tpye parsing:");
        ...
        private static void UseDatesAndTimes()
        {
            ...
            // What day of the DateTime is this?
        ...
        private static void UseBigInteger()
        {
            ...
            BigInteger reallyBig = BigInteger.Multiply(biggy, BigInteger.Parse("888888888888888888888888888888888"));
